  ...
  * Permite navegar a las distintas funcionalidades: Explorar publicaciones, Ver mis postulaciones, Perfil.
  */
   ...
   const menuItems = [
     {
       ...
       description: "Explora las ofertas laborales y ventas de artículos disponibles.",
     ...
     },
     {
       ...
       description: "Revisa y gestiona el estado de tus postulaciones activas.",
         ...
         <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-10 flex flex-col items-center justify-center min-h-[80vh]">
             ...
             <div className="text-center mb-16 max-w-3xl animate-in fade-in slide-in-from-bottom-4 duration-700">
                 ...
                 <h1 className="text-5xl md:text-6xl font-black tracking-tight drop-shadow-2xl mb-6 leading-tight">
                     ...
                     <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-purple-100 to-purple-200">Postulante</span>
                 </h1>
                 <p className="text-xl text-purple-100/80 font-medium max-w-2xl mx-auto">
                     Explora oportunidades laborales y ventas de artículos disponibles para la comunidad universitaria.
                 </p>
             </div>
