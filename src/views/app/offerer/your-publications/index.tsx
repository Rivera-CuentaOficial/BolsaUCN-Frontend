...
import type { PublicationForOfferor } from "@/models/responses"; 
...
export default function YourPublicationsView() {
  ...
  useEffect(() => {
    ...
    router.replace(`/offerer/your-publications${newUrl}`, { scroll: false });
  ...
  const handleViewDetail = (pub: PublicationForOfferor) => {
    router.push(`/offerer/your-publications/${pub.publicationId}`);
  };
          ...
          <header className="mb-10">
            ...
            <div className="flex flex-col items-start gap-2">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/20 backdrop-blur-md border border-white/30 text-white text-xs font-bold uppercase tracking-wider shadow-lg transform rotate-1">
                ...
                {user?.userType === "Estudiante" ? "Panel del Estudiante" : "Panel del Oferente"}
              </div>
              ...
              <p className="text-purple-100 text-lg md:text-xl font-medium mt-3 drop-shadow-md">
                Tienes un total de <span className="text-yellow-300 font-black text-2xl align-middle">{totalCount}</span> publicaciones registradas.
              </p>
            </div>
          </header>
